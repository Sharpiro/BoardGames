...
class ChessSquareFactory
{
    ...
    public static getSquares(gameBoard: GameBoard<ChessSquare>, squaresX: number, squaresY: number, squareWidth: number, squareHeight: number): ChessSquare[]
    {
        ...
        let pieces: ChessSquare[] = [
            //white misc
            new Rook(gameBoard, whiteRookIcon, 1, 1, Owner.Computer),
            new Knight(gameBoard, whiteKnightIcon, 2, 1, Owner.Computer),
            new Bishop(gameBoard, whiteBishopIcon, 3, 1, Owner.Computer),
            new King(gameBoard, whiteKingIcon, 5, 1, Owner.Computer),
            new Queen(gameBoard, whiteQueenIcon, 4, 1, Owner.Computer),
            new Bishop(gameBoard, whiteBishopIcon, 6, 1, Owner.Computer),
            new Knight(gameBoard, whiteKnightIcon, 7, 1, Owner.Computer),
            new Rook(gameBoard, whiteRookIcon, 8, 1, Owner.Computer),

            //white pawns
            new Pawn(gameBoard, whitePawnIcon, 1, 2, Owner.Computer),
            new Pawn(gameBoard, whitePawnIcon, 2, 2, Owner.Computer),
            new Pawn(gameBoard, whitePawnIcon, 3, 2, Owner.Computer),
            new Pawn(gameBoard, whitePawnIcon, 4, 2, Owner.Computer),
            new Pawn(gameBoard, whitePawnIcon, 5, 2, Owner.Computer),
            new Pawn(gameBoard, whitePawnIcon, 6, 2, Owner.Computer),
            new Pawn(gameBoard, whitePawnIcon, 7, 2, Owner.Computer),
            new Pawn(gameBoard, whitePawnIcon, 8, 2, Owner.Computer),

            //black pawns
            new Pawn(gameBoard, blackPawnIcon, 1, 7, Owner.Player),
            new Pawn(gameBoard, blackPawnIcon, 2, 7, Owner.Player),
            new Pawn(gameBoard, blackPawnIcon, 3, 7, Owner.Player),
            new Pawn(gameBoard, blackPawnIcon, 4, 7, Owner.Player),
            new Pawn(gameBoard, blackPawnIcon, 5, 7, Owner.Player),
            new Pawn(gameBoard, blackPawnIcon, 6, 7, Owner.Player),
            new Pawn(gameBoard, blackPawnIcon, 7, 7, Owner.Player),
            new Pawn(gameBoard, blackPawnIcon, 8, 7, Owner.Player),
            ...
            new King(gameBoard, blackKingIcon, 4, 8, Owner.Player),
            new Queen(gameBoard, blackQueenIcon, 5, 8, Owner.Player),
