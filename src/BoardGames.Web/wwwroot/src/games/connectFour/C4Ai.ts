...
//        const randomMove = LogicBoard.getRandomEmptyPos(this.squares);
//        this.squares = null;
//        return randomMove;
//    }
...
//                if (winCounter === 3)
//                {
//                    const problemPos = pos - 3 * LogicBoard.segmentsX;
...
//                        const problemPos = currentPos - 3 * LogicBoard.segmentsX;
...
//    {
//        const rowLowerPos = pos + LogicBoard.segmentsX;
//        const maxPositions = LogicBoard.segmentsX * LogicBoard.segmentsY - 1;
